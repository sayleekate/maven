...
import  testcases.ReusableClass;
import project2.LogingObjects;
public class LoginTests extends ReusableClass {
	public static String filePath="C:\\Users\\Kate\\Desktop\\xlsx";
	public static String sheetName="SignUpInfo";	
LogingObjects lo=new LogingObjects();
